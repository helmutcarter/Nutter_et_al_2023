...
absdPSI_cutoff = 0.10
use_absdPSI_cutoff = False
event_list = ["SE","MXE","A5SS","A3SS","RI"]
intron_distances = [25] 
print_two = False
...
path_to_fasta1 = "/path/to/appropriate/genome/assembly/for/first/rMATS/Homo_sapiens.GRCh38.dna.primary_assembly.fa"
path_to_fasta2 = "/path/to/appropriate/genome/assembly/for/first/rMATS/Mus_musculus.GRCm38.dna.primary_assembly.fa"

orthology_file = "/path/to/appropriate/orthology/file/human_mouse_homology_ensembl_IDs.csv"
...
if __name__ == "__main__":
	...
	for intron_distance in intron_distances:
		filename_ending = f".DM1_ChP_vs_2KO_ChP.{count_cutoff}count_no_dPSI_cutoff.tsv"
